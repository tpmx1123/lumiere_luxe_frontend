  ...
  return (
    <div className="font-inter text-[#2C2521] leading-relaxed min-h-screen relative overflow-hidden bg-white">
      ...
      <img 
        ...
        className="absolute top-[-10px] -left-[45px] w-[170px] h-[190px] z-[1] opacity-90 object-contain pointer-events-none hidden lg:block" 
      />
      ...
      <div className="py-5 pb-[200px] relative z-[2] min-h-screen flex flex-col md:pb-[150px] sm:pb-[100px]">
        <div className="max-w-[1200px] mx-auto px-5 relative">
          ...
          <p className="font-inter text-salon-dark-brown text-[1.2rem] text-center max-w-[1200px] mx-auto mt-[5px] mb-5 leading-[1.3] font-normal lg:text-[1.2rem] md:text-[1.1rem] sm:text-base sm:max-w-[90%]">
          ...
          <div className="absolute bottom-[-375px] left-0 right-0 text-center z-[3] pointer-events-none h-[40%] flex items-end justify-center md:bottom-[-300px] md:h-[30%] sm:bottom-[-200px] sm:h-[30%]">
            <img 
              src={NailImage} 
              alt="Nail care" 
