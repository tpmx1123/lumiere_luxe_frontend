                ...
                <div className="contact-methods">
                  <div className="contact-method" onClick={handleMapClick}>
                    ...
                    <div className="contact-text">
                      <h3>Visit Us</h3>
                      <p>123 Luxury Lane<br />Madhapur, Hyderabad<br />Telangana 500081</p>
                      <span className="click-hint">Click to open in Maps</span>
                    </div>
                  </div>

                  <div className="contact-method" onClick={() => handlePhoneClick('+919876543210')}>
                    <div className="contact-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="contact-method" onClick={() => handleEmailClick('info@lumiereluxe.com')}>
                    <div className="contact-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="contact-text">
                      <h3>Email Us</h3>
                      <p>info@lumiereluxe.com<br />bookings@lumiereluxe.com</p>
                  ...
                  <div className="contact-method" onClick={handleWhatsAppClick}>
                    ...
                    <div className="contact-text">
                      <h3>WhatsApp</h3>
                      <p>+91 98765 43210<br />Quick booking & inquiries</p>
